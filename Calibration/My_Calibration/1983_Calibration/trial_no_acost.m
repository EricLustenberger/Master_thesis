...
if jage < T_ret;
    ...
    v_hat_xprime = reshape(reshape(MUc,size(c_pol,1)*size(c_pol,2),size(c_pol,3))*1.0*beta_,size(c_pol,1),size(c_pol,2),size(c_pol,3));
    v_hat_dprime = reshape(reshape(MUd,size(c_pol,1)*size(c_pol,2),size(c_pol,3))*1.0*beta_,size(c_pol,1),size(c_pol,2),size(c_pol,3));
