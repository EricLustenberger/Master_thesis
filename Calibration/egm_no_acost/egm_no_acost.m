...
% figures, simulation, normalized Euler equation errors
% =======================================================
% nice_figure1.m
% figure2;
...
%eulererrors_no_acost;
%eulererrors_average_no_acost;

solutions.mean_durab = averages(2);
solutions.total_wealth = sum(x_t)/mean(y_t);
