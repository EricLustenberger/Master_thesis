...
figure(57);
subplot(1,3,1);
plot(SCF_agedetail_pctiles(10:90,1),SCF_agedetail_pctiles(10:90,2),SCF_agedetail_pctiles_1983(10:90,1),SCF_agedetail_pctiles_1983(10:90,2),(10:90),x_26_35_perc_composed(10:90),'--','LineWidth',3), xlabel('Percentile','fontsize',14), ylabel('Net worth','fontsize',14);
title('Age 26-35','fontsize',14);
legend('2004','1983','Model','Location','NorthWest')
set(gca,'XTick',10:10:90)
set(gca,'XTickLabel',{'10','','30','','50','','70','','90'})
axis([10,90,0,18]);
subplot(1,3,2);
plot(SCF_agedetail_pctiles(10:90,1),SCF_agedetail_pctiles(10:90,3),SCF_agedetail_pctiles_1983(10:90,1),SCF_agedetail_pctiles_1983(10:90,3),(10:90),x_36_45_perc_composed(10:90),'--','LineWidth',3), xlabel('Percentile','fontsize',14), ylabel('Net worth','fontsize',14);
...
axis([10,90,0,18]);
subplot(1,3,3);
plot(SCF_agedetail_pctiles(10:90,1),SCF_agedetail_pctiles(10:90,4),SCF_agedetail_pctiles_1983(10:90,1),SCF_agedetail_pctiles_1983(10:90,4),(10:90),x_46_55_perc_composed(10:90),'--','LineWidth',3), xlabel('Percentile','fontsize',14), ylabel('Net worth','fontsize',14);
...
figure(58);
subplot(1,3,1);
plot(SCF_agedetail_pctiles(:,1),SCF_agedetail_pctiles(:,2),SCF_agedetail_pctiles_1983(:,1),SCF_agedetail_pctiles_1983(:,2),(1:99),x_26_35_perc_composed,'--','LineWidth',3), xlabel('Percentile','fontsize',14), ylabel('Net worth','fontsize',14);
title('Age 26-35','fontsize',14);
legend('SCF data','Model','Location','NorthWest')
...
axis([1,100,-1,18]);
subplot(1,3,2);
plot(SCF_agedetail_pctiles(:,1),SCF_agedetail_pctiles(:,3),SCF_agedetail_pctiles_1983(:,1),SCF_agedetail_pctiles_1983(:,3),(1:99),x_36_45_perc_composed,'--','LineWidth',3), xlabel('Percentile','fontsize',14), ylabel('Net worth','fontsize',14);
title('Age 36-45','fontsize',14);
legend('SCF data','Model','Location','NorthWest')
set(gca,'XTick',10:10:100)
set(gca,'XTickLabel',{'20','','40','','60','','80','','100'})
axis([1,100,-1,18]);
subplot(1,3,3);
plot(SCF_agedetail_pctiles(:,1),SCF_agedetail_pctiles(:,4),SCF_agedetail_pctiles_1983(:,1),SCF_agedetail_pctiles_1983(:,4),(1:99),x_46_55_perc_composed,'--','LineWidth',3), xlabel('Percentile','fontsize',14), ylabel('Net worth','fontsize',14);
title('Age 46-55','fontsize',14);
legend('SCF data','Model','Location','NorthWest')
set(gca,'XTick',10:10:100)
set(gca,'XTickLabel',{'20','','40','','60','','80','','100'})
