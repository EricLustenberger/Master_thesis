...
\multicolumn{4}{l}{%
  \begin{minipage}{10.5cm}%
    \small Net-worth is measured in units of average population net labor-earnings, which is adjusted by the household size using the equivalent scale introduced by  \cite{fernandez2007consumption}. Source: \cite{hintermaier2011} Table 2}
  \end{minipage}%
\\
\end{tabular}
\end{table}
...
\multicolumn{2}{l}{Durables}             & 0.991    & 0.764  & 2.9560 & 2.3886      \\ \hline \hline
\multicolumn{1}{l}{%
  \begin{minipage}{10.5cm}%
...
This appendix shows the Gini-specifications, which are used above. 
