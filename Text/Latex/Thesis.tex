...
Durables and especially housing make up an important part of a households portfolio. Especially, young households as well as poorer households tend not to hold financial assets. (CITE SOME PAPERS). Houses are often used as collateral and thus are important for the accumulation of savings. 
Various theoretical papers have investigated the importance of durables for the accumulation of wealth. Namely \citep{FV&K2011} has pointed out, that including durables in a model is particularly important for the reproduction of life-cycle profiles. Others, such as \cite{diaz2010} have shown that portfolio choices can be modeled. 

I will contribute to this literature, I thus seek to match a life-cycle models with durables to the data, using micro-funded data on income, and the distribution of net-worth from \cite{hintermaier2011}, who investigated the accuracy of an out-of-sample prediction of a very similar life-cycle model, however, excluding durables. 

There are several determinants of savings in such a model. I seek to show, how these may affect different age groups in an averse manner. Of particular importance is the loan to value ratio.

I show, that such a model reproduces the life-cycle models quite well. Moreover, it fits the wealth distribution in quite well. 
