...
The exogenous grids for x is chosen as follows 

 Moreover, the values for the exogenous grid are chosen such that the results are not affected. (BE MORE PRECISE
