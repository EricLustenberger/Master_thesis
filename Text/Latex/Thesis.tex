...
The limited variety of assets implies an incomplete market structure, which hinders consumers to perfectly diversify away the idiosyncratic risk from income uncertainty. The ex-ante identical consumers thus will thus, depending on their income trajectory, end up with different portfolios of the endogenous state variables. Moreover, the optimal decision will depend on the consumers age. The model is therefore well suited to match  net-worth distributional facts  introduced above, as well as differences across ages. \\

\subsection{The determinants of savings}
\label{determinants}

\paragraph{The experience premium and retirement benefits} As will be described further below, the model incorporates an experience premium as well as retirement benefits. This part of the income is deterministic and thus consumers's perfectly anticipate it. 


income increases as their working experience grows. But as they get older their productivity decreases again,which leads to a hump shaped income. Rational consumers perfectly anticipate this part of earnings
