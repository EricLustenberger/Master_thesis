...
\\ These facts show, that explicitly modeling durables seems particularly interesting for the sample of 26 to 55 years old. 
...
Finally, it is important to note that this calibration implies a smallest income larger than one. Moreover, this thus implies that the collaterizable income $\underline{y}$ is larger than zero and corresponds to the smallest income across all ages including the retirement period and is thus well defined for all periods. 
