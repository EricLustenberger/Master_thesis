...
The present section discussed that the model does manage to match different aspects of the net-worth distribution observed in the data quite well. Moreover, it is able to reproduce an empirical plausible pattern of relative inequality across the distribution of the endogenous variables and income. Finally, modeling durables may help to improve the models performance in matching the average net-worth holdings over the life-cycle. Durables, however, do not seem to affect the concentration of net-worth.


\section{Changes in the Loan-to-value ratio}
...
Chaning the loan-to-value ratio is particularly interesting, since it manages to capture features of financial liberalization.  
