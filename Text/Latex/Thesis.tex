...
The previous discussion on the life-cycle profiles and the distribution have shown that the collateral value of durables is important to correctly specify the early accumulation of net-worth. In this section I perform a counter factual experiment to further develop intuition about the role of the collateral value of durables. In order to do so, I re-run the model with a different value for the loan-to-value ration and observe how this affects outcomes discussed in the previous section. \\
Changing the LTV allows to capture certain aspects of the financial liberalization. The loan-to-value has shrunk considerably over the period prior to 
