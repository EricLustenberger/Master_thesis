...
The modeling of durables does therefore not seem to affect the concentration of net-worth substantially, however it may improve the models prediction of the mean holdings of net-worth across the life-cycle. \cite{FV&K2011} point out that in a model without durables and a non-borrowing constraint, agent do tend to accumulate more assets early on in live, since they are not able to insure against future income shock by accumulating durables. The lower average durable stock predicted for the oldest age-group, may be due to differences in the risk-aversion and discount factor, which are due to the out-of-sample prediction. 
