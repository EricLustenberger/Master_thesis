...
as reported by \citet{benhabib2011distribution} heterogeneity in rates of returns might account for the sharper increase in net-worth. Finally, the bequest motive may have some influence. \cite{denardi2014}. It may be interesting to include such features. ))))))
...
\printbibliography                      % Erstellt Literaturverzeichnis (bindet das file bib_thesis.bib ein
